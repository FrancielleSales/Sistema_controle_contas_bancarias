...
public class Banco {
	...
	public static void main(String args[]) {
		...
		// pessoa fisica = {cpf, nome, dataNasc., RG, renda}
		...
		contas.add(new Conta(1, "Conta Comum", "10/10/1998", true, "123mudar", 1000f, pessoas.get(0)));
		contas.add(new Conta(2, "Conta Comum","01/07/2012", true, "456mudar", 2200f, pessoas.get(0)));

		// conta especial = {numero, data abertura, status, senha, saldo, limite, dono da conta}
		contas.add(new ContaEspecial(3, "Conta Especial", "05/03/2004", true, "789mudar", 10000f, 3000f, pessoas.get(1)));
		contas.add(new ContaEspecial(4, "Conta Especial","15/10/2013", true, "999mudar", 20000, 5000f, pessoas.get(3)));

		// conta poupanca = {numero, data abertura, status, senha, saldo, dia aniversario, dono da conta}
		contas.add(new ContaPoupanca(5, "Conta Poupança","05/05/2020", true, "789mudar", 10000f, 10, pessoas.get(1)));
		contas.add(new ContaPoupanca(6, "Conta Poupança","05/05/2020", true, "789mudar", 2000f, 23, pessoas.get(2)));
